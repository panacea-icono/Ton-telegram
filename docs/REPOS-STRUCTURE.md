# 📦 Estructura de Repos – Panacea Icono SA
...
- infra/privacidad_seguridad → https://github.com/panacea-icono/privacidad_seguridad.git — Sin descripción
- infra/repositorio-modular-fibonacci-ia-integrado → https://github.com/panacea-icono/repositorio-modular-fibonacci-ia-integrado.git — simulador medico quirúrgico de riesgo FIBONACCI-APP
...
- labs/codex-main → https://github.com/panacea-icono/codex-main.git — editor de codigo gpt
- labs/Dr_dela_TV → https://github.com/panacea-icono/Dr_dela_TV.git — repositorio modular de todos los demas repositorios como presentadcor del ecosistema
- labs/dr_tv_gp → https://github.com/panacea-icono/dr_tv_gp.git — Sin descripción
- labs/dr_tv_GPT → https://github.com/panacea-icono/dr_tv_GPT.git — repositorio oficial
- labs/dr-de-la-tvr → https://github.com/panacea-icono/dr-de-la-tvr.git — Sin descripción
- labs/dua_lipa_model_image_ia → https://github.com/panacea-icono/dua_lipa_model_image_ia.git — generador de imágenes de dua lipa
- labs/gpt-local → https://github.com/panacea-icono/gpt-local.git — 🤖 Sistema de chat GPT local con Hugging Face - Soporte Docker, CLI y múltiples modelos
- labs/GPT-MAESTRO-PANACEA → https://github.com/https-panacea-icono-org/GPT-MAESTRO-PANACEA.git — GPT-MAESTRO-PANACEA
- labs/GPTApi → https://github.com/panacea-icono/GPTApi.git — API DE GRANO FINO
- labs/home → https://github.com/panacea-icono/home.git — Sin descripción
...
- labs/MEDIOS-REDES → https://github.com/panacea-icono/MEDIOS-REDES.git — Este repositorio contiene un conjunto de bots diseñados para interactuar en diversas redes sociales. Los bots están programados para realizar tareas como automatización de respuestas, gestión de publicaciones, y análisis de interacciones. El objetivo es facilitar la interacción con los usuarios y mejorar la eficiencia en la gestión.
- labs/MODELOS → https://github.com/panacea-icono/MODELOS.git — ONLY FANS
- labs/nextjs-with-supabase → https://github.com/panacea-icono/nextjs-with-supabase.git — Sin descripción
- labs/PANACEA_MD → https://github.com/panacea-icono/PANACEA_MD.git — PANACEA UNVERSIDAD BOLIVIANA APP DE ENSEÑANZA EN CIRUGIA PLASTICA
- labs/PANACEA-API-CENTRAL-CODEX → https://github.com/panacea-icono/PANACEA-API-CENTRAL-CODEX.git — API EMPRESA
- labs/PANACEA-GPT-I → https://github.com/panacea-icono/PANACEA-GPT-I.git — INGENIARIA DE BOTS Y DESARROLLO DE INTELIGENCIA AUTOGEGERATIVA
- labs/panacea-icono → https://github.com/panacea-icono/panacea-icono.git — PANACEA ICONO: AI-Powered Healthcare Solutions with Docker and Hugging Face Integration
- labs/panas_multichain → https://github.com/panacea-icono/panas_multichain.git — token multicadena
- labs/panas_pay → https://github.com/panacea-icono/panas_pay.git — Sin descripción
- labs/panas-pay → https://github.com/panacea-icono/panas-pay.git — Decentralized P2P payment platform on Algorand blockchain
- labs/Panas-Pay.M → https://github.com/panacea-icono/Panas-Pay.M.git — Sin descripción
- labs/REDES → https://github.com/panacea-icono/REDES.git — Sin descripción
- labs/Super-code-tasker → https://github.com/https-panacea-icono-org/Super-code-tasker.git — SuperCodeTasker is a modular repository that hosts multiple AI-powered code generation agents. Built with OpenAI GPT integration and designed for flexibility, this platform enables task-specific agents to assist in software development, automation, and creative coding.

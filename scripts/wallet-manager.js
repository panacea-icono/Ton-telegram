...
class WalletManager {
    ...
    loadWalletConfig() {
        ...
        this.addWallet('DR_IGNACIO_MAIN', {
            ...
            accessToken: 'IJRJmqtDtMPM0xw0hTUuOMYlmW8upCdzeYCxbIgcxiQzlPasguGi3W3EtfBm0Mxc',
        ...
        this.addWallet('IVANA_WALLET', {
            ...
            id: 'BHL4ZT_5HHW3E',
            addresses: {
                algorand: ['BHLAZTPJS2IKXFP3A2T7WJX2SPFNFE2JRAA5WGWLMIEWBSTEEIE35HHW3E']
            },
            securityLevel: 'HIGH',
            createdAt: new Date().toISOString()
        });
    ...
    generateSecurityReport() {
        ...
        if (report.securitySummary.low > 0) {
            report.recommendations.push('Actualizar wallets con nivel de seguridad bajo');
        }
    ...
    switch (command) {
        ...
        case 'info':
            ...
            try {
                ...
                console.log(JSON.stringify(walletManager.getWalletInfo(walletId), null, 2));
            } catch (error) {
        ...
        case 'validate':
            ...
            console.log(`🔍 Validación de dirección ${address} en ${network}: ${isValid ? '✅ Válida' : '❌ Inválida'}`);
            break;

        case 'security':
            console.log('🔒 Reporte de Seguridad:');
            console.log(JSON.stringify(walletManager.generateSecurityReport(), null, 2));
            break;

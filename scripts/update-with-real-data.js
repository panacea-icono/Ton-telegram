...
class RealDataUpdater {
  constructor() {
    ...
    this.repositories = [
      ...
      },
      {
        ...
        cloneUrl:
          'https://github.com/panacea-icono/repositorio-modular-fibonacci-ia-integrado.git',
        sshUrl:
          'git@github.com:panacea-icono/repositorio-modular-fibonacci-ia-integrado.git',
  ...
  generateUpdatedReadme() {
    const mainRepo =
      this.repositories.find((repo) => repo.mainRepo) || this.repositories[0];
